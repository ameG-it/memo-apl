...
var crypter_1 = require("../common/crypter");
var user_1 = require("../models/user");
var jsonwebtoken_1 = require("jsonwebtoken");
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var password, _a, iv, encryptedData, user, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                _a = (0, crypter_1.encrypt)(password), iv = _a.iv, encryptedData = _a.encryptedData;
                req.body.password = encryptedData;
                req.body.passwordIv = iv;
                return [4 /*yield*/, user_1.User.create(req.body)];
            case 2:
                user = _b.sent();
                token = jsonwebtoken_1.default.sign({ id: user._id }, "secretley", {
                    expiresIn: "24h",
                });
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, user, decryptPassword, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 2:
                ...
                decryptPassword = (0, crypter_1.decrypt)(user.passwordIv, user.password);
